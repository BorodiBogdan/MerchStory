...
\begin{itemize}
    ...
    \item To develop a recommendation engine that suggests fresh marketing ideas on a daily basis, grounded in real-world contextual signals such as the weather, upcoming holidays and nearby events, so that the platform is useful as an everyday tool rather than a one-off generator.
...
During the preparation of this work the author used ChatGPT to improve the language and readability of the thesis. After using ChatGPT, the I reviewed and edited the content as needed. All experimental results, model training, system design, evaluation, and scientific conclusions are entirely my own work. I take full responsibility for the accuracy and integrity of the final document.
