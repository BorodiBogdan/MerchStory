...
Chapter~\ref{chap:architecture} treated the recommendation engine and the hybrid catalogue mode as services with a fixed contract. This chapter looks inside both, with a shorter closing section on the print pipeline that supports them.
