...
\begin{table}[!ht]
\centering
\caption{Compound acceptance probability under the independent-trial model, given a single-trial acceptance rate of $0.70$. The pipeline caps at three trials in production; the four- and five-trial rows are shown to make the diminishing marginal gain from raising the cap visible.}
