...
namespace MerchStoryAPI.Migrations
{
    ...
    [Migration("20260615153747_AddCanViewRecommendationsToAppUser")]
    partial class AddCanViewRecommendationsToAppUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MerchStoryAPI.Models.AppUser", b =>
                {
                    ...
                    b.Property<bool>("CanViewRecommendations")
            ...
            modelBuilder.Entity("MerchStoryAPI.Models.CreditTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid?>("RelatedGeneratedImageId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RelatedGeneratedImageId");
            ...
            modelBuilder.Entity("MerchStoryAPI.Models.PrintJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PrintLinkId");

                    b.HasIndex("SourceGeneratedImageId");
            ...
            modelBuilder.Entity("MerchStoryAPI.Models.PrintLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MerchStoryAPI.Models.CreditTransaction", b =>
                {
                    b.HasOne("MerchStoryAPI.Models.GeneratedImage", "RelatedGeneratedImage")
                        .WithMany()
                        .HasForeignKey("RelatedGeneratedImageId")
                    ...
                    b.Navigation("RelatedGeneratedImage");
            ...
            modelBuilder.Entity("MerchStoryAPI.Models.PrintJob", b =>
                {
                    b.HasOne("MerchStoryAPI.Models.PrintLink", "PrintLink")
                        .WithMany()
                        .HasForeignKey("PrintLinkId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MerchStoryAPI.Models.GeneratedImage", "SourceGeneratedImage")
                        .WithMany()
                        .HasForeignKey("SourceGeneratedImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PrintLink");

                    b.Navigation("SourceGeneratedImage");
            ...
            modelBuilder.Entity("MerchStoryAPI.Models.PrintLink", b =>
                {
                    b.HasOne("MerchStoryAPI.Models.AppUser", "OwnerUser")
                        .WithMany()
